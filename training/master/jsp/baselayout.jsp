...
<link href="<s:url value="/master/css/default.css"/>" rel="stylesheet"
	type="text/css" />
<link href="<s:url value="/master/css/jquery-ui.css"/>" rel="stylesheet"
	type="text/css" />

<script type="text/javascript" src="<s:url value="/master/js/jquery-1.7.1.min.js"/>"></script>
<script type="text/javascript" src="<s:url value="/master/js/jquery-ui.min.js"/>"></script>
